...
# Configuration Paths
GLOBAL_PARAMETERS_CONFIG_FILE_PATH = os.path.join(
    "configs", "common", "global_parameters.json"
)
COMPARE_OMNIENS_PRODUCT_INFOS_WITH_TY_AND_HB_CONFIG_FILE_PATH = os.path.join(
    "configs", "compare_omniens_product_infos_with_ty_and_hb.json"
)
SAVE_TY_PARTNER_PRODUCT_URLS_TO_EXCEL_CONFIG_FILE_PATH = os.path.join(
    "configs", "save_trendyol_partner_product_urls_to_excel.json"
)
...
# Jinja Paths
JINJA_FOLDER_PATH = os.path.join("common", "templates")
